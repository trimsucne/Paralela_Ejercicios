...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            // Para hacer
            // Calcula la suma de los recíprocos de los elementos en el rango
    ...
    protected static double parArraySum(final double[] input) {
        ...
        ReciprocalArraySumTask task1 = new ReciprocalArraySumTask(0, middle, input);
        ReciprocalArraySumTask task2 = new ReciprocalArraySumTask(middle, input.length, input);
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        tasks[numForkTasks] = new ReciprocalArraySumTask(getChunkStartInclusive(numForkTasks, numTasks,
                input.length), getChunkEndExclusive(numForkTasks, numTasks, input.length), input);
        tasks[numForkTasks].compute();
        sum += tasks[numForkTasks].getValue();
